	...
	>
		...
		<div class="flex w-full justify-center">
			<div class="flex w-full lg:w-11/12 xl:w-10/12 flex-col max-w-1220">
				...
				>
					<!-- Title -->
					<h1 v-if="profile" class="text-lightPrimaryText dark:text-darkPrimaryText text-3xl font-semibold xl:text-4xl">
						Hello, {{ profile.name }}
					</h1>
					<h1 v-else class="text-lightPrimaryText dark:text-darkPrimaryText text-3xl font-semibold xl:text-4xl">
						Hello!
					</h1>
					<Nodes />
				</div>
