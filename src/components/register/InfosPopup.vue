				...
				<div class="text-sm">
					<div class="flex flex-col my-4">
						...
						<p class="my-2 text-gray5 dark:text-gray3">
							...
							with small amounts of NEAR token. You’ll need to solve the captcha to verify your human identity and
							enable Capsule Social to sponsor you with NEAR tokens. Blogchain and Capsule Social doesn't store or track
							any information from your Google account. To log in, use your Google account or import your Blogchain
					...
					<div class="flex flex-col my-4">
						...
						<p class="my-2 text-gray5 dark:text-gray3">
							...
							with small amounts of NEAR token. You’ll need to solve the captcha to verify your human identity and
							enable Capsule Social to sponsor you with NEAR tokens. Blogchain and Capsule Social doesn't store or track
							information on your accounts. To log in, use your Discord account or import your Blogchain private key
					...
					<div class="flex flex-col my-4">
						...
						<p class="my-2 text-gray5 dark:text-gray3">
							Create an account where you self manage your account keys. You’ll need solve the captcha to verify your
							human identity and enable Capsule Social to sponsor you with NEAR tokens. These NEAR tokens are used for
							performing transactions on a smart contract and registering your account on the blockchain. By signing up
							with this method, you’ll need to download your Blogchain private key and use it to log in under “Import
