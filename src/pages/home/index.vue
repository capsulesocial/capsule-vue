<template>
	<div class="w-full">
		...
		>
			...
			<!-- Not loaded yet -->
			<article v-show="this.isLoading" class="flex justify-center" style="width: 500px">
				<div class="loader m-5"></div>
			</article>

			<article v-for="post in this.posts" :key="post.contentAddress" style="padding-left: 10px">
				<PostCard :post="post" />
			</article>
		</section>
	</div>
