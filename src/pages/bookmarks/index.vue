<template>
	<div ref="container">
		...
		>
			...
			<img src="/images/Bookmarks.webp" class="top-0 mt-64 xl:-mt-2" />
		</article>
		...
		<p v-if="posts.length > 0" class="text-gray5 dark:text-gray3 py-5 text-center text-sm">No more posts</p>
		<!-- Not loaded yet -->
