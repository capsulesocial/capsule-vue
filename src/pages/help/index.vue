<template>
	<main class="w-full xl:w-750">
		<section>
			<!-- Page title -->
			<article class="px-4 xl:px-6 py-4 xl:py-5">
				<h1 class="font-semibold text-primary text-3xl xl:text-4xl">Need Some Help?</h1>
			</article>
			<div class="container px-4 xl:px-6 pb-6">
				<h3 class="text-primary text-xl font-semibold mb-6 mt-4">Frequently Asked Questions</h3>
				<article class="message w-full xl:w-10/12 mb-4">
					<div class="message-header flex justify-between items-center relative" @click="toggleAccordion1">
						<h4 class="text-lightPrimaryText text-base font-semibold w-10/12">
				...
				<article class="message w-full xl:w-10/12 mb-4">
					<div class="message-header flex justify-between items-center relative" @click="toggleAccordion4">
						<h4 class="text-lightPrimaryText text-base font-semibold w-10/12">Can I post to Blogchain for free?</h4>
